...
import ExportExel from "../../Pages/Test";
...
function App() {
 ...
 const [title,setTitle]= useState('Bảng tin')
  ...
  return ( <creatTitle.Provider value={{handleTitle:handleTitle}}>
        <div className="App flex">
      <LeftBar toggleBar={toggleBar} />
      <div className={" h-screen " +(toggleBar==false?"nav-bar":"second-nav")}>
      ...
      <div className="Content mt-1 overflow-auto ">
          <Routes>
            ...
            <Route path="/test" element={<ExportExel/>} />
          </Routes>
        </div>
      </div>
    </div>
