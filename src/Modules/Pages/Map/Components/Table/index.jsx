...
function Table() {
  ...
  return (
    <div className="bg-gray-500 h-full w-1/3 absolute right-0 top-0">
      <Link to="/map">
      ...
      <div className=" flex py-2">
        {measureType.map((b, index) => {
          return (
            <button className=" w-1/3 rounded-full mx-2 text-blue-400 bg-slate-50">
              {generate(index)}
              {b.title} <CheckIcon />
            </button>
          )
      ...
      <div className="mt-5 px-2 text-black">
        <div className="flex">
          ...
          <div className="flex items-start w-4/12 py-2 mx-0.5 mt-0.5 font-semibold  bg-slate-50">
            Tên trạm đo
          </div>
          <div className="flex items-start w-3/12 py-2 mx-0.5 mt-0.5 font-semibold bg-slate-50">
            Giá trị đo
          </div>
          <div className="flex items-start w-4/12 py-2 mx-0.5 mt-0.5 font-semibold bg-slate-50">
            Thời điểm đo
        ...
        <div className="flex">
          <div className="w-7 py-2 mx-0.5 mt-0.5 bg-slate-50 ">
            <SwitchCameraIcon />
          </div>
          <div className="w-4/12 py-2 mx-0.5 mt-0.5  bg-slate-50">
            Tên trạm đo
          </div>
