...
function DashBoard({props}) {
  ...
  return <div className="DashBoard m-7">
    <Grid container spacing={2}>
      <Grid item xs={4} >
        <div className="bg-white shadow-xl border-2 border-solid border-[#4285F4] rounded-[15px] h-[200px] flex flex-col justify-center items-center">
          <p className="uppercase text-[#4285F4] font-bold leading-[19px]">đo thấm dấu</p>
          <p className="text-[#4285F4] font-[1000] text-[100px] leading-[117px]">0</p>
          <p className="text-[#4285F4] font-normal italic text-base leading-[16px]">Số báo động</p>
        </div>
      </Grid>
      <Grid item xs={4} >
        <div className="bg-white shadow-xl border-2 border-solid border-[#EA4335] rounded-[15px] h-[200px] flex flex-col justify-center items-center">
          <p className="uppercase text-[#EA4335] font-bold leading-[19px]">đo áp lực thấm dấu</p>
          <p className="text-[#EA4335] font-[1000] text-[100px] leading-[117px]">2</p>
          <p className="text-[#EA4335] font-normal italic text-base leading-[16px]">Số báo động</p>
        </div>
        {
          true ?
            <>
      ...
      <Grid item xs={4} >
        <div className="bg-white shadow-xl border-2 border-solid border-[#4285F4] rounded-[15px] h-[200px] flex flex-col justify-center items-center">
          <p className="uppercase text-[#4285F4] font-bold leading-[19px]">đo khe co giãn dấu</p>
          <p className="text-[#4285F4] font-[1000] text-[100px] leading-[117px]">0</p>
          <p className="text-[#4285F4] font-normal italic text-base leading-[16px]">Số báo động</p>
        </div>
      </Grid>
